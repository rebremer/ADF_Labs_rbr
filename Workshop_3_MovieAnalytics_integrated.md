...
## Ingesting data from a public storage account into Azure Data Lake Storage Gen2
...
1. **Write to an Azure SQL Database** Once you have finished your transformation logic, you are ready to write to your sink. In this lab, you are going to create a new Azure SQL Sink. To add a sink, click on the + icon next to your Aggregate transformation and select Sink.
    ...
    Name your linked service `AzureSQL` and change **Authentication Type** to **System Assigned Managed Identity**. Then this the connection (make sure that you have interactive auditing enabled on Managed VNET). **Make sure you know what database to connect to**
